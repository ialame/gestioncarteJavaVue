            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="set in sets" :key="set.id">
                        ...
                        <td>
                            <div class="float-end">
                                <a title="Modifier" :href="`/cards/onepiece/sets/${set.id}`" target="_blank" rel="noopener" class="btn btn-link me-2 p-0 no-focus">
                                    <Icon name="pencil" />
                                </a>
                                <a title="Cartes" :href="`/cards/onepiece/sets/${set.id}/list`" target="_blank" rel="noopener" class="btn btn-link me-2 p-0 no-focus">
                                    <Icon name="list" />
                                </a>
                            </div>
                        </td>
...
import {OnePieceSetLabel, onePieceSetService} from "@components/cards/onepiece/set";
import {useOnePieceTitle} from "@components/cards/onepiece/logic";

useOnePieceTitle("Liste de extensions");

const sets = onePieceSetService.all;
